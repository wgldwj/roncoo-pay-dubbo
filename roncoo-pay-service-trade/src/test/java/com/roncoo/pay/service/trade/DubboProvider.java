...
//			rpTradePaymentOrder.setReturnUrl("http://");// 页面通知地址
//			rpTradePaymentOrder.setNotifyUrl("http://");// 后台通知地址
...
//			rpTradePaymentRecord.setReturnUrl("http://");// 页面通知地址
//			rpTradePaymentRecord.setNotifyUrl("http://");// 后台通知地址
