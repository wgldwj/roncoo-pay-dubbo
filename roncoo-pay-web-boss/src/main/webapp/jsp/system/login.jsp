...
<body>
	<div id="login">
		<div id="login_header">
			<h1 class="login_logo">
				<a href="http://" target="_blank"><img src="${baseURL }/dwz/themes/default/images/login_logo.png" /></a>
			</h1>
		...
		<div id="login_content">
			...
			<div class="login_banner"><img src="${baseURL }/dwz/themes/default/images/ZengHao,WuShuicheng..jpg" /></div>
		...
		<div id="login_footer">
			Copyright &copy; 2015-2016 <a href="http://" target="_blank">陈德元</a>
		</div>
	</div>
</body>
</html>