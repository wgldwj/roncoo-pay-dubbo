 ...
 *
 */
public class RoncooPayAppNotify
{
    private static final Log LOG = LogFactory.getLog(RoncooPayAppNotify.class);
    ...
    public static void main(String[] args) {
        ...
        synchronized (RoncooPayAppNotify.class) {
            while (true) {
                try {
                    RoncooPayAppNotify.class.wait();
